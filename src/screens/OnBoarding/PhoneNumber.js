...
export default function App({ ...props }) {
    ...
    const validateNumber = () =>{
        if(phone === undefined || phone === null || phone.trim() === "" || phone.trim().length !== 10){
            alert("Phone number can't be blank and it should be 10 digit.!!");
            return false
        }
        if(isNaN(phone.trim())){
        ...
        <KeyboardAvoidingView behavior='position'
            ...
            <View >
                ...
                >
                    ...
                    <TouchableOpacity onPress={() => props.navigation.push("Password", {email: props.route.params.email, username: props.route.params.username, phone:""})}>
